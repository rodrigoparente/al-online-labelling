...
if __name__ == '__main__':
    ...
    if getattr(sys, 'frozen', False) and hasattr(sys, '_MEIPASS'):
        ...
        results_path = os.path.join(os.path.dirname(sys.executable), 'results', '')
    ...
    creating_initial_pool_test(initial_size=20, test_size=60, seed=42)
    ...
    active_learning_labelling(name,
                              model_name='gb',
                              al_query_strategy='uncertainty-sampling',
                              number_queries=100)
